...
<div id="dlg" class="easyui-dialog" style="width:800px;height:500px" resizable="true"
    ...
    <br>
        ...
        <#--开发计划详情记录-->
        <table id="dg02" class="easyui-edatagrid" style="width:700px;height:200px" title="开发计划项" toolbar="#toolbar002"  pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
            <thead>
            <tr>
